...
# - 核心用途：执行“🚪双击打开Github.JobsOCKit”对应的 Git / Sourcetree 自动化操作。
...
show_script_intro_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】🚪双击打开Github.JobsOCKit.command'
  print -r -- '核心用途：执行“🚪双击打开Github.JobsOCKit”对应的 Git 自动化操作。'
