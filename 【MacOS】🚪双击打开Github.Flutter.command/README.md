# `【MacOS】🚪双击打开Github.Flutter.command`
...
- 本自述文件对应脚本：`【MacOS】🚪双击打开Github.Flutter.command`。
...
| 项目 | 说明 |
|---|---|
| 脚本名称 | `【MacOS】🚪双击打开Github.Flutter.command` |
...
```shell
chmod +x './【MacOS】🚪双击打开Github.Flutter.command'
'./【MacOS】🚪双击打开Github.Flutter.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🚪双击打开Github.Flutter.log`。
