#!/bin/zsh
# 脚本自述：
# - 脚本名称：【MacOS】⚙️双击为私人账户生成 SSH 密钥（加密手段：RSA 4096 + ED25519 二选一）.command
# - 核心用途：执行“⚙️双击为私人账户生成 SSH 密钥（加密手段：RSA 4096 + ED25519 二选一）”对应的自动化任务。
...
show_readme_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】⚙️双击为私人账户生成 SSH 密钥（加密手段：RSA 4096 + ED25519 二选一）.command'
  print -r -- '核心用途：执行“⚙️双击为私人账户生成 SSH 密钥（加密手段：RSA 4096 + ED25519 二选一）”对应的自动化任务。'
