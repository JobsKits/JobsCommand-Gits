#!/bin/zsh
# 脚本自述：
# - 脚本名称：【MacOS】⚙️双击生成Github远程仓库URL.command
# - 核心用途：执行“⚙️双击生成Github远程仓库URL”对应的 Git / Sourcetree 自动化操作。
...
show_readme_and_wait() {
  clear
  print -r -- '============================== 脚本内置自述 =============================='
  print -r -- '脚本名称：【MacOS】⚙️双击生成Github远程仓库URL.command'
  print -r -- '核心用途：执行“⚙️双击生成Github远程仓库URL”对应的 Git 自动化操作。'
