# `【MacOS】🚪双击打开Github.JobsOCBaseConfigDemo.command`
...
- 本自述文件对应脚本：`【MacOS】🚪双击打开Github.JobsOCBaseConfigDemo.command`。
...
```shell
chmod +x './【MacOS】🚪双击打开Github.JobsOCBaseConfigDemo.command'
'./【MacOS】🚪双击打开Github.JobsOCBaseConfigDemo.command'
```
...
- 运行日志默认写入：`$TMPDIR/【MacOS】🚪双击打开Github.JobsOCBaseConfigDemo.log`。
